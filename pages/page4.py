...
layout = html.Div(children = [
        ...
        # Income Categories and Affordable Shelter Costs, 2016
            ...
            html.Div([
                ...
                # Description
                html.Div([
                    html.H6('The following table shows the range of Indigenous household incomes and affordable shelter costs for each income category, in 2015 dollar values, as well what percentage of the total number of Indigenous households that fall within each category.')
